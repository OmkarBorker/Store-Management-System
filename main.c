...
void d_mainmenu()
{
    int i;
    char ch;
    const char *menu[]= {"   Calculate Bill -'press enter on keyboard'","   Add Goods      -'press enter on keyboard'","   Edit Goods     -'press enter on keyboard'","   Display All    -'press enter on keyboard' ","   Search         -'press enter on keyboard'", "   Delete Goods   -'press enter on keyboard'","   Exit           -'press enter on keyboard'"};
    system("cls");
...
//;
    for (i=1; i<=5; i++)
        printf("--");
    printf(" * BORKER SUPER STORES * ");
    for (i=1; i<=5; i++)
        printf("--");
    printf("\n\n");
    gotoxy(28,11);
    printf("\t GENRAL SUPER STORE");
...
void window(int a,int b,int c,int d)
{
    ...
    printf("\xbc");
    gotoxy(60,60);
    printf("MADE BY-OMKAR BORKER[TM]");
